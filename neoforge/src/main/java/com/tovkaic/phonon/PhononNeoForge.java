...
import com.tovkaic.phonon.audio.AudioPersistence;
import com.tovkaic.phonon.audio.AudioResource;
import com.tovkaic.phonon.command.PhononCommand;
import com.tovkaic.phonon.network.PhononNetwork;
...
public class PhononNeoForge {
    ...
    private void onPlayerJoin(net.neoforged.neoforge.event.entity.player.PlayerEvent.PlayerLoggedInEvent event) {
        if (event.getEntity() instanceof net.minecraft.server.level.ServerPlayer player) {
            ...
            var packet = new com.tovkaic.phonon.network.packets.SyncAudioResourcesPacket(resources);
